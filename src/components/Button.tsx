...
const styles = {
  ...
  plain: [
    // Base
    'border-transparent text-zinc-950 data-active:bg-zinc-950/5 data-hover:bg-zinc-950/5 px-3 py-1.5 text-sm md:px-4 md:py-2 md:text-base lg:px-5 lg:py-2.5 whitespace-nowrap',
    // Dark mode
