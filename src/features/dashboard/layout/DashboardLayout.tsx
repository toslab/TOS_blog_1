...
import MainMenuPanel from '../../../app/dashboard/components/layout/MainMenuPanel'; // 새로운 컴포넌트
import { SidebarProvider, useSidebar } from '../../../app/dashboard/contexts/SidebarContext';
import { SearchProvider } from '../../../app/dashboard/contexts/SearchContext';
import PanelManager from '../common/PanelManager';
